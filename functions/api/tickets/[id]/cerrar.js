...
export async function onRequestPost({ request, env, params }) {
  ...
  if (!body.fecha_solucion_crm || !body.fecha_solucion_cda) {
    return badRequest("Debe indicar la fecha de cierre del CRM y del CDA.");
  }
  ...
  await logCambio(db, {
    ticket_id: ticket.id,
    tipo_cambio: "cierre",
    campo: "fecha_solucion_crm",
    valor_anterior: ticket.fecha_solucion_crm,
    valor_nuevo: body.fecha_solucion_crm,
